...
namespace Client.FileSending
{
    public class FileSender : IFileSender
    {
        ...
        private readonly IServerService proxy;
        private readonly IFileInUseChecker fileInUseChecker;
        public FileSender(IServerService proxy, IFileInUseChecker fileInUseChecker, StorageTypes storageType, string uploadPath)
        {
